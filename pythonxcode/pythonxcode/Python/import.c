...
{
    //printf("in find_module fullname is %s\n", fullname);
    Py_ssize_t i, npath;
    size_t len, namelen;
...
load_module(char *name, FILE *fp, char *pathname, int type, PyObject *loader)
{
    ...
    //printf("in load_module type is %d\n", type);
    ...
    *p_buflen = 0;
    ...
    if ((pkgname != NULL) && (pkgname != Py_None)) {
        ...
        if (modpath != NULL) {
            ...
            //printf("in get_parent modname is %s\n", start);
          ...
          Py_ssize_t *p_buflen)
{
    ...
    //printf("in load_next *p_name is %s\n", name);
